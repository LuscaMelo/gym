        ...
        <Box py={9} px={5}>
            <Flex flexDir={["column"]} justifyContent="center" alignItems="center" w="100%">
                ...
                >
                    ...
                    <Text color="gray" py={2} maxWidth="400px" fontSize={["xs", "sm", "md"]}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quidem alias repellat corrupti sed rem sit officiis dicta, esse eius, atque dolorum praesentium.</Text>
    ...
    return (
        <Box pb={20}>
            <Container maxW="container.md">
                ...
                <Grid templateColumns={["1fr", "repeat(2, 1fr)", "repeat(2, 1fr)"]} gap={1}>
                    <Box>
